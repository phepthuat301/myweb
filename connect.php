		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item"><a class="nav-link active" href="connect.php">Liên Hệ</a></li>
				</ul>
			</div>
		</div>
	</nav>
	...
	<div class="container-fluid padding">
		<div class="row text-center padding">
			...
			<div class="col-12 social padding">
				<a href="https://www.facebook.com/groups/1449361468676500"><i class="fab fa-facebook" id="fbicon"></i></a> 
				<a href="tel:0582199020"><i class="fas fa-mobile-alt"></i></a>
